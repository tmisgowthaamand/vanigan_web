...
const PageHeader = ({ title, subtitle }) => {
    return (
        <section className="relative pt-36 pb-16 bg-[#14110D] overflow-hidden border-b border-[var(--ks-rule)]" style={{ fontFamily: 'var(--ks-font-body)' }}>
            ...
            <div className="max-w-[1320px] mx-auto px-6 relative z-10 text-center">
                <span className="inline-flex items-center gap-2 border border-[var(--ks-rule-strong)] px-4 py-2 rounded-[3px] mb-7">
                ...
                {subtitle && (
                    <p className="max-w-2xl mx-auto text-[17px] text-[var(--ks-text-muted)] font-normal leading-[1.7]">
                        {subtitle}
                    </p>
                )}
            </div>
